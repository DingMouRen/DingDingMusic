    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void bindData(MusicBean bean,MusicBean playingBean){
            if (null != bean){
                ...
                Glide.with(mContext).load(bean.getAlbumpic_small()).asBitmap().diskCacheStrategy(DiskCacheStrategy.NONE).placeholder(R.mipmap.notification_img_holder).into(imgAlbum);
            }
